...
PLUGIN_DESCRIPTION = "Writes income statement for ticker symbol to a csv file."
ARGS_SCHEMA = {
    "ticker": Argument(type="string", description="Stock ticker symbol"),
    "filename": Argument(type="string", description="Name of csv file to which income statement will be written")
}
